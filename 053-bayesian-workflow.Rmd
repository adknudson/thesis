...
```{r ch053-plot-pf-with-lapse, fig.cap="Psychometric function with lower and upper performance bounds."}
...
```{stan ch053-Eager Modern Parachute, output.var="av_iter4_obs_fit"}
functions {
...
```{r ch053-Furious Ninth Xylophone}
m5_4_1_pred %>%
  ggplot(aes(x, p)) +
