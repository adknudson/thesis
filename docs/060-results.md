...
\caption{Posterior distribution of PSS values for the audiovisual task.}(\#fig:ch060-Eastern-Cat)
\end{figure}
...
\caption{Posterior distribution of PSS values for the audiovisual task. Left: Marginal over age group. Right: Marginal over block.}(\#fig:ch060-Beta-Lonesome)
\end{figure}
...
\caption{Distribution of differences for pre- and post-adaptation PSS values with 90% HPDI.}(\#fig:ch060-Omega-Permanent)
\end{figure}
...
\caption{Posterior distribution of PSS values for the visual task.}(\#fig:ch060-Gruesome-Waffle)
\end{figure}
...
\caption{The difference between the older age group and the two others is noticeable, but not likely significant.}(\#fig:ch060-Cold-Gamma)
\end{figure}
...
\caption{The bulk of the distribution is above zero, but there is still a chance that there is no difference in the distribution of PSS values between the age groups during the visual TOJ experiment.}(\#fig:ch060-Rapid-Postal)
\end{figure}
...
\caption{Posterior distribution of PSS values for the duration task.}(\#fig:ch060-Stormy-Frostbite)
\end{figure}
...
\caption{Posterior distribution of PSS values for the sensorimotor task.}(\#fig:ch060-Homeless-Anaconda)
\end{figure}
...
\caption{Posterior distribution of JND values for the audiovisual task.}(\#fig:ch060-Timely-Toupee)
\end{figure}
...
\caption{Posterior distribution of JND values for the visual task.}(\#fig:ch060-Mercury-Rainbow)
\end{figure}
...
\caption{Posterior distribution of JND values for the duration task.}(\#fig:ch060-Aimless-Planet)
\end{figure}
...
\caption{Posterior distribution of JND values for the sensorimotor task.}(\#fig:ch060-Tombstone-Cold)
\end{figure}
...
\caption{Process model of the result of a psychometric experiment with the assumption that lapses occur at random and at a fixed rate, and that the subject guesses randomly in the event of a lapse.}(\#fig:ch060-Waffle-Hollow)
\end{figure}
...
\caption{(\#tab:ch060-Orange-Tigerfish)Relative difficulty of the different tasks by age group. The difficulty is measured by the proportion of incorrect responses.}
\centering
