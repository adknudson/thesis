...
As a default, we will be using the \texttt{rethinking} package \citep{R-rethinking} which is built on top of \texttt{rstan} \citep{R-rstan}. The rethinking package provides a high-level interface to Stan -- a C-compiled Markov chain Monte Carlo (MCMC) sampler -- while still being flexible enough to specify complex Bayesian models.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{m1_}\DecValTok{0}\NormalTok{ <-}\StringTok{ }\KeywordTok{alist}\NormalTok{(}
\NormalTok{  response }\OperatorTok{~}\StringTok{ }\KeywordTok{bernoulli_logit}\NormalTok{(p),}
  \DataTypeTok{p =}\NormalTok{ a }\OperatorTok{+}\StringTok{ }\NormalTok{b }\OperatorTok{*}\StringTok{ }\NormalTok{soa,}
  
\NormalTok{  a }\OperatorTok{~}\StringTok{ }\KeywordTok{normal}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{100}\NormalTok{),}
\NormalTok{  b }\OperatorTok{~}\StringTok{ }\KeywordTok{normal}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{100}\NormalTok{)}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{f1_}\DecValTok{0}\NormalTok{ <-}\StringTok{ }\KeywordTok{ulam}\NormalTok{(m1_}\DecValTok{0}\NormalTok{, }\DataTypeTok{data =}\NormalTok{ simulated_data, }\DataTypeTok{chains =} \DecValTok{8}\NormalTok{, }\DataTypeTok{cores =} \DecValTok{8}\NormalTok{, }\DataTypeTok{log_lik =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{f1_}\DecValTok{0}\NormalTok{ <-}\StringTok{ }\KeywordTok{ulam}\NormalTok{(m1_}\DecValTok{0}\NormalTok{, }\DataTypeTok{data =}\NormalTok{ observed_data, }\DataTypeTok{chains =} \DecValTok{8}\NormalTok{, }\DataTypeTok{cores =} \DecValTok{8}\NormalTok{, }\DataTypeTok{log_lik =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
