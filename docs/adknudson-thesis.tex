...
{\centering \includegraphics[width=0.7\linewidth]{adknudson-thesis_files/figure-latex/simple-response-soa-plot-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{adknudson-thesis_files/figure-latex/av-post1-O-f-CE-plot-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{adknudson-thesis_files/figure-latex/av-post-neg-trials-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{adknudson-thesis_files/figure-latex/naive-prop-outliers-1} 
...
From here the classical process would be to take the derivative of \eqref{eq:bernloglik}, set it equal to \(0\), and solve for \(\theta\). Additionally one might perform a second derivative test to ensure that the solution is indeed a maximizer to \eqref{eq:bernloglik}. However no closed form exists for \eqref{eq:bernloglik}, and so numerical methods like gradient descent are used to iteratively find the MLE solution.
...
\hypertarget{steps-of-the-workflow}{%
\section{Steps of the Workflow}\label{steps-of-the-workflow}}

\hypertarget{selecting-priors}{%
\section{Selecting Priors}\label{selecting-priors}}
